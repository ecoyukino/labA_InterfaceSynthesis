<project xmlns="com.autoesl.autopilot.project" name="array_io_prj" top="array_io">
    ...
    <files xmlns="">
        <file name="../../array_io_test.c" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="../../result.golden.dat" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="array_io.c" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
    </files>
    <solutions xmlns="">
        ...
        <solution name="RollDualPort" status="inactive"/>
        <solution name="unrolled" status="inactive"/>
        <solution name="sol2Out2" status="inactive"/>
