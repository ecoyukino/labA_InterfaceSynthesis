...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("d_o_address1", 5, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("d_o_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("d_o_we1", 1, hls_out, 0, "ap_memory", "MemPortWE2", 1),
	Port_Property("d_o_d1", 16, hls_out, 0, "ap_memory", "MemPortDIN2", 1),
