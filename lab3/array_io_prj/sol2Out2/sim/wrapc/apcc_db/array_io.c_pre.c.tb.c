...
void array_io_hw_stub(signed short *llvm_cbe_d_o, signed short *llvm_cbe_d_i);
void apatb_array_io_sw(signed short *llvm_cbe_d_o, signed short *llvm_cbe_d_i);
void apatb_array_io_ir(signed short *, signed short *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = srem i32 %%storemerge1, 8, !dbg !5 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_12_count);
  llvm_cbe_tmp__1 = (unsigned int )((signed int )(((signed int )llvm_cbe_storemerge1) % ((signed int )8u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__1));
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%2 to i64, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__2 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [8 x i32]* @aesl_internal_array_io.acc, i64 0, i64 %%3, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_18_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = load i32* %%4, align 4, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_19_count);
  llvm_cbe_tmp__4 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = sext i32 %%storemerge1 to i64, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__5 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds i16* %%d_i, i64 %%6, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__6 = (signed short *)(&llvm_cbe_d_i[(((signed long long )llvm_cbe_tmp__5))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__5));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load i16* %%7, align 2, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__7 = (unsigned short )*llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = sext i16 %%8 to i32, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_23_count);
  llvm_cbe_tmp__8 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = add nsw i32 %%9, %%5, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_24_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%10, i32* %%4, align 4, !dbg !5 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_27_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = trunc i32 %%10 to i16, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__10 = (unsigned short )((unsigned short )llvm_cbe_tmp__9&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds i16* %%d_o, i64 %%6, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__11 = (signed short *)(&llvm_cbe_d_o[(((signed long long )llvm_cbe_tmp__5))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__5));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%11, i16* %%12, align 2, !dbg !4 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_30_count);
  *llvm_cbe_tmp__11 = llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = add nsw i32 %%storemerge1, 1, !dbg !5 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_31_count);
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @array_io_hw_stub\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @array_io(i16* %%d_o, i16* %%d_i), !dbg !4 for 0x%I64xth hint within @array_io_hw_stub  --> \n", ++aesl_llvm_cbe_44_count);
   /*tail*/ array_io((signed short *)llvm_cbe_d_o, (signed short *)llvm_cbe_d_i);
if (AESL_DEBUG_TRACE) {
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @array_io_hw_stub}\n");
  return;
}
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @apatb_array_io_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @apatb_array_io_ir(i16* %%d_o, i16* %%d_i) nounwind, !dbg !4 for 0x%I64xth hint within @apatb_array_io_sw  --> \n", ++aesl_llvm_cbe_50_count);
   /*tail*/ apatb_array_io_ir((signed short *)llvm_cbe_d_o, (signed short *)llvm_cbe_d_i);
if (AESL_DEBUG_TRACE) {
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @apatb_array_io_sw}\n");
  return;
}
